...
Public Class Pengeluaran
    ...
    Private Sub Pengeluaran_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Text = "OUT-" & id
        Button2.Enabled = False
        Me.FormBorderStyle = FormBorderStyle.FixedSingle
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        CMD = New OleDbCommand("INSERT INTO tbl_kas VALUES ('" & TextBox1.Text & "','" & DateTimePicker1.Value.Date & "','0','" & TextBox2.Text & "','" & TextBox3.Text & "','" & Form1.ToolStripStatusLabel4.Text & "')", conn)
        CMD.ExecuteNonQuery()
        MsgBox("Pengeluaran Berhasil disimpan", MsgBoxStyle.Information, "Success")
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("NOTA PENGELUARAN KAS", New Drawing.Font("Arial", 10), Brushes.Black, 10, 25)
