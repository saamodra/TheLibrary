...
Public Class PengembalianTahunan
    Private Sub PengembalianTahunan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TampilGrid()
        DataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
    End Sub
    Sub TampilGrid()
        Dim Str As String = "select * from [tbl_transaksi] where format(dikembalikan_tgl, 'yyyy') = '" & Format(DateTimePicker1.Value, "yyyy") & "'"
