...
Public Class PengembalianBulanan
    Private Sub PengembalianBulanan_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TampilGrid()
        DataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
    End Sub
    Sub TampilGrid()
        Dim Str As String = "select * from [tbl_transaksi] where format(dikembalikan_tgl, 'MM/yyyy') = '" & Format(DateTimePicker1.Value, "MM/yyyy") & "'"
        ...
        Do While dr.Read()
            Dim row As String()
            Dim i As Integer = 0
            row = New String() {dr.Item("id_transaksi").ToString(), dr.Item("id_anggota").ToString(), dr.Item("nama").ToString(), dr.Item("id_buku").ToString(), dr.Item("judul").ToString(), Format(dr.Item("tgl_pinjam"), "dd/MM/yyyy")}
            ...
            DataGridView1.Columns(5).Name = "Tanggal Pinjam"
