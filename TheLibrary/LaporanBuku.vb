...
Public Class LaporanBuku
    ...
    Sub TampilGrid()
        Dim Str As String = "SELECT * FROM tbl_buku"
        ...
        Do While dr.Read()
            ...
            lv.SubItems.Add(dr.Item("rak").ToString())
    ...
    End Sub
    Private Sub LaporanBuku_Load(sender As Object, e As EventArgs) Handles MyBase.Load
