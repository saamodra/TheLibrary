...
Public Class PengembalianHarian
    Private Sub PengembalianHarian_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TampilGrid()
        DataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill
    End Sub
    Sub TampilGrid()
        Dim Str As String = "select * from [tbl_transaksi] where [dikembalikan_tgl] = #" & Format(DateTimePicker1.Value, "MM/dd/yyyy") & "#"
