...
Public Class KasKeluar
    ...
    Sub TampilGrid()
        Dim Str As String = "select * from [tbl_kas] where [tanggal] between #" & DateTimePicker1.Value.Month & "/" & DateTimePicker1.Value.Day & "/" & DateTimePicker1.Value.Year & "# and #" & DateTimePicker2.Value.Month & "/" & DateTimePicker2.Value.Day & "/" & DateTimePicker2.Value.Year & "# and [pemasukan] = '0'"
        ...
        Do While dr.Read()
            Dim row As String()
            Dim i As Integer = 0
            row = New String() {dr.Item("id").ToString(), Format(dr.Item("tanggal"), "dd/MM/yyyy"), FormatCurrency(dr.Item("pengeluaran")), dr.Item("keterangan").ToString(), dr.Item("operator").ToString()}
            DataGridView1.ColumnCount = 5
            DataGridView1.Columns(0).Name = "ID"
            DataGridView1.Columns(1).Name = "Tanggal"
            DataGridView1.Columns(2).Name = "Pengeluaran"
    ...
    End Sub
    Sub Total()
        Dim Str As String = "SELECT SUM(pengeluaran) FROM tbl_kas WHERE [tanggal] between #" & DateTimePicker1.Value.Month & "/" & DateTimePicker1.Value.Day & "/" & DateTimePicker1.Value.Year & "# and #" & DateTimePicker2.Value.Month & "/" & DateTimePicker2.Value.Day & "/" & DateTimePicker2.Value.Year & "#"
        Dim cmd As New OleDb.OleDbCommand(Str, conn)
        ...
        End If
    End Sub
    Private Sub KasKeluar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("Laporan Kas Keluar", New Font("Arial", 20), Brushes.Black, rect, sf)
        ...
        For p As Integer = startPage To pages.Count - 1
            ...
            Else
                startPage = 0
            End If
            e.Graphics.DrawString("Total Kas Keluar = " & Label5.Text, New Font("Arial", 13), Brushes.Black, 500, startY + 20)
        Next
    End Sub
